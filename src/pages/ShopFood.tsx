...
const foodItems = [
  {
    ...
    discount: "20%",
    rating: 4.8,
    desc: "Complete and balanced nutrition for adult dogs. Rich in protein and essential nutrients.",
  },
  {
    ...
    discount: "20%",
    rating: 4.9,
    desc: "Specially formulated for puppies. Supports healthy growth and immune system.",
  },
  {
    name: "Applaws Natural Cat Food",
    image: "https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=300&h=300&fit=crop",
    price: 19.99,
    discount: "20%",
    rating: 4.7,
    desc: "Grain-free, high-protein food for cats. Made with natural ingredients.",
  },
  {
    name: "Whiskas Chicken Gravy",
    image: "https://images.unsplash.com/photo-1518715308788-3005759c61d3?w=300&h=300&fit=crop",
    price: 14.99,
    discount: "20%",
    rating: 4.6,
    desc: "Tasty chicken gravy for cats. Enriched with vitamins and minerals.",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 dark:from-purple-900 dark:via-blue-900 dark:to-black flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center py-8 sm:py-12 px-2 sm:px-4 w-full pt-44">
        <div className="w-full max-w-6xl flex flex-col items-center mb-6 sm:mb-8">
          <h1 className="mt-8 text-3xl sm:text-4xl md:text-5xl font-extrabold text-center bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent drop-shadow-2xl uppercase tracking-wide mb-4 sm:mb-6" style={{letterSpacing: '0.04em'}}>Food Essentials</h1>
        </div>
