...
const toysItems = [
  {
    ...
    image: "https://images.unsplash.com/photo-1605641781021-7c4a86d10af6?w=300&h=300&fit=crop",
    price: 15.99,
    discount: "30%",
    rating: 4.8,
    desc: "Soft, squeaky plush toy for hours of fun. Safe for all pets.",
  },
  {
    ...
    discount: "30%",
    rating: 4.7,
    desc: "Colorful feather teaser wand for cats. Encourages exercise and play.",
  },
  {
    ...
    discount: "30%",
    rating: 4.6,
    desc: "Durable rubber ball for dogs. Great for fetch and chewing.",
  },
  {
    ...
    discount: "30%",
    rating: 4.9,
    desc: "Catnip-filled mouse toy for cats. Irresistible and fun!",
  },
];

const ShopToys: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 dark:from-purple-900 dark:via-blue-900 dark:to-black flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center py-8 sm:py-12 px-2 sm:px-4 w-full pt-44">
        <div className="w-full max-w-6xl flex flex-col items-center mb-6 sm:mb-8">
          <h1 className="mt-8 text-3xl sm:text-4xl md:text-5xl font-extrabold text-center bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent drop-shadow-2xl uppercase tracking-wide mb-4 sm:mb-6" style={{letterSpacing: '0.04em'}}>Toys</h1>
        </div>
